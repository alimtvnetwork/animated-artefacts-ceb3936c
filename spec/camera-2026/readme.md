...
| `02-squircle-mask-black.png` | **Source mask reference.** The live runtime mask is `src/assets/camera-2026/squircle-mask.png`, applied via `mask-image` to crop the video (v3). |
| `03-squircle-plate-white-shadow.png` | **White plate source variant.** Regenerated 2026-06-05 from `04`; same shape + drop shadow with a white rim. Not the current live runtime plate, but available as the white-rim source asset. |
| `04-squircle-plate-gold-shadow.png` | **Source plate reference.** The live runtime plate is `src/assets/camera-2026/squircle-plate-gold.png`, rendered behind the video with a transparent interior (v3). |
